...
export class HeaderComponent implements OnInit {
  ...
  constructor(private categoryService: CategoryService, public router: Router, private authService: AuthService, private customerService: CustomerService) {
  ...
  ngOnInit() {
    ...
    this.customerService.currentSearch.subscribe(searchItem => {
